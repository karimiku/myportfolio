            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                ...
                >
                    <h2 className="text-4xl lg:text-5xl font-display font-bold italic mb-4 pr-16 overflow-visible" style={{ overflow: 'visible' }}>
                        <span className="gradient-text" style={{ overflow: 'visible', paddingRight: '2rem' }}>経歴</span>
                    </h2>
                        ...
                        {experiences.map((exp, index) => (
                            ...
                            >
                                ...
                                <div className="w-5/12 max-md:w-full">
                                    ...
                                    >
                                        {/* Arrow */}
                                        <div className={`absolute top-8 ${index % 2 === 0 ? '-right-3' : '-left-3'
                                            } w-6 h-6 bg-gradient-to-r from-primary-500 to-purple-500 rotate-45`}></div>
                                ...
                                <div className="w-2/12 flex justify-center max-md:w-auto max-md:absolute max-md:left-8 max-md:top-8">
                                    <motion.div
                                        ...
                                        viewport={{ once: true }}
                                        className="w-4 h-4 bg-gradient-to-r from-primary-500 to-purple-500 rounded-full border-4 border-dark-900 relative z-10"
                                    ></motion.div>
                                </div>
