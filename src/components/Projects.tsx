...
const Projects: React.FC = () => {
  const projects: Project[] = [
    ...
    },
    {
      ...
      image: "/projects/team-communication.svg",
  ...
  return (
    <section id="projects" className="py-20 bg-white/60 overflow-visible">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tags.map((tag, tagIndex) => (
                    <span
                      key={tagIndex}
                      className="px-3 py-1 bg-primary-500/15 text-primary-200 rounded-full text-xs font-medium border border-primary-500/30"
                    >
                      {tag}
                    </span>
                  ))}
